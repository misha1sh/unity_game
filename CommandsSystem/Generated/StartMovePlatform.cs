...
namespace CommandsSystem.Commands {
    public partial class StartMovePlatform : ICommand  {

        public StartMovePlatform(){}
        
        public StartMovePlatform(int id,int direction) {
            this.id = id;
...
arr[4] = (byte)(direction & 0x000000ff);
   ...
   arr[7] = (byte)((direction & 0xff000000) >> 24);
        ...
        private static StartMovePlatform DeserializeLittleEndian(byte[] arr) {
            var result = new StartMovePlatform();
            unsafe {
...
result.direction = (arr[4] | (arr[5] << 8) | (arr[6] << 16) | (arr[7] << 24));
        ...
        public static StartMovePlatform Deserialize(byte[] arr) {
            if (BitConverter.IsLittleEndian)
        ...
        public override string ToString() {
            return "StartMovePlatform " + AsJson();
        }
    }
}